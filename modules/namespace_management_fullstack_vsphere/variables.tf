...
variable "management_switch_interfaces" {
  default = [
    "vmnic0"
  ]
}
variable "management_switch_active_uplinks" {
  default = [
    "uplink1"
  ]
}
variable "management_switch_standby_uplinks" {
  default = [
  ]
}
variable "management_switch_max_mtu" {
  type = number
  default = 1500
}
variable "management_switch_allow_mac_changes" {
  type = bool
  default = false
}
...
variable "data_switch_name" {
  type = string
}
variable "data_switch_interfaces" {
  default = [
    "vmnic0"
  ]
}
variable "data_switch_active_uplinks" {
  default = [
    "uplink1"
  ]
}
variable "data_switch_standby_uplinks" {
  default = [
  ]
}
variable "data_switch_max_mtu" {
  type = number
  default = 1500
}
variable "data_switch_allow_mac_changes" {
  type = bool
  default = false
}
...
variable "workload_switch_interfaces" {
  default = [
    "vmnic0"
  ]
}
variable "workload_switch_active_uplinks" {
  default = [
    "uplink1"
  ]
}
variable "workload_switch_standby_uplinks" {
  default = [
  ]
}
variable "workload_switch_max_mtu" {
  type = number
  default = 1500
}
variable "workload_switch_allow_mac_changes" {
  type = bool
  default = true
}
...
variable "workload_network_vlan" {
  type = string
  default = "0"
}
